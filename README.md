...
- **Pazaryeri soyutlaması** (`lib/pazaryeri`): motor platform bilmez. Her
  ...
  Altısı da kayıtlı: Trendyol, Hepsiburada, N11, Pazarama, idefix, Amazon
  (`docs/pazaryeri/*.md`; her belgenin "Doğrulanacaklar" listesi canlı hesapla
  kapatılır). Amazon için sunucuda `AMAZON_LWA_CLIENT_ID/SECRET` gerekir.
