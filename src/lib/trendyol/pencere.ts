...
/** İlk senkronda geriye gidilen gün sayısı (PartnerSys ile aynı: 30 gün). */
 ...
 *
 * - Daha önce senkron olduysa: son senkrondan 5 dk GERİ. Trendyol'un yazma
 ...
 *   satıra düşer.
 * - Hiç senkron olmadıysa: 30 günlük geçmiş.
 */
export function senkronBaslangici(
  ...
  return simdi.getTime() - ILK_SENKRON_GUN * GUN_MS;
}
